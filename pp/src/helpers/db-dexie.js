...
db.on("populate", function() {
  if(firebase.FIREBASE_ENVIROMENT){
    ...
    console.log("expenses added sussefull")
    ...
    console.log("expenseStock added sussefull")
  }
});
