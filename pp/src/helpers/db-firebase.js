...
const getExpenses = () => proxyGets(RAM[Table.EXPENSE])
...
const getExpensesStocks = () => proxyGets(RAM[Table.EXPENSE_STOCKS])
...
const getQuoteAnalysis = () => proxyGets(RAM[Table.QA_ANALYSIS])
